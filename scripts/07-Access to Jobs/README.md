...
For the displacement index, the `DataGen_07_AccessToJobs.R` script transforms these raw CSV files into data sets that can be used for the displacement index - isolating the 2020 Census Tract geographies and the corresponding average number of jobs - `07_a_AccesstoJobs.csv` and `07_b_AccesstoJobs.csv`.
