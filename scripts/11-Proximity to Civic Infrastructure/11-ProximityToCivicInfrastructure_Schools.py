...
# tract_output_df = tract_output_df.rename(columns={'Census2020Tract': 'GEOID20', 'wt_avg': 'school'})
# tract_output_df = tract_output_df[['GEOID20', 'school']]
# tract_output_df.to_csv(r'Y:\VISION 2050\Data\Displacement\Displacement Index 2021\data\11-Proximity to Civic Infrastructure\11_a_ProximityCivicInfraSchool_new.csv', index=False)
...
# new_df_lu = new_df_lu.merge(population_df, left_on='parcelid', right_on='hhparcel', how='inner')
...
# parcel_dict = {
#     district: group
#     for district, group in parcel_school_district.groupby("lea_name")
# }
