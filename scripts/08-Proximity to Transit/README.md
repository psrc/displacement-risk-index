...
Percent of population within ¼ mile to frequent or high capacity transit. These values are based on current population (2023 base year) and is weighted by the total population (not households). 
